...
if [ -n "$A_rxn" ]; then
    ...
    ./RXN_SS_SUBS_P_J_y_contextRXN_react_produ.awk ../PREP/P_RXN/scr_18_Jul_22/unique_all_rxds.tsv > output1.tsv
    #./RXN_SS__SUBS_journal_patent_intersection_year_contextRXN.awk ../PREP/P_RXN/scr_28_Aug_22/pruebis.tsv > output2.tsv
    echo "output 1 done"    
    ./SS_rxnsIDE_years_acumm.awk output1.tsv > output2.tsv
